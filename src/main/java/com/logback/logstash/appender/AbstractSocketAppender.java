 ...
 *
 * This is an extended version of AbstractSocketAppender provided  in logback-core.
 * It is mostly the same except that you can provide an encoder too
 */
...
public abstract class AbstractSocketAppender<E> extends AppenderBase<E>
    ...
    protected Socket waitForConnectorToReturnASocket() throws InterruptedException {
        try {
